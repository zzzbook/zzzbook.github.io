...
- 函数 $P(x \vert theta)$ ，其中 $x$ 表示某一个具体数据； $\theta$ 表示模型的参数；
...
- **推导过程**
  ...
  4. 其中 $x_n\in\{0,1\}$ 满足0-1分布 $f(x)=p^x(1-p)^{1-x}= \begin{cases} p,& x=1 \newline 1-p,& x=0 \end{cases}$ ，故转变为 $\prod_{i=1}^{n}y_i^{x_i}(1-y_i)^{1-x_i}$ 
